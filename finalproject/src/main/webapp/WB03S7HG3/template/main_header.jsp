...
<!-- 로그인 유무로 인해 변경
					...
					<a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownMessages"
						href="<%=request.getContextPath()%>/template/main.jsp?group=template&worker=login;" role="button"
					data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">로그인</a>
					<a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage"
						href="<%=request.getContextPath()%>/template/main.jsp?group=template&worker=register" role="button"
					...
					<a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownMessages"
						href="<%=request.getContextPath()%>/template/main.jsp?group=template&worker=profile;" role="button"
					data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">내정보</a>
						<if(loginMember.memberStatus() == 9) { %>
						<a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownMessages"
						href="<%=request.getContextPath()%>/template/main.jsp?group=template&worker=#;" role="button"
					data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">관리자</a>					
-->
</body>