            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
               <ul class="navbar-nav">
                  <li class="nav-item dropdownx">
                     <a class="nav-link dropdown-toggle1" href="#" id="navbarDropdownPortfolio" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     영화
                     </a>
                     <!--  
                  ...
                  <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle1" href="#" id="navbarDropdownPortfolio" aria-haspopup="true" aria-expanded="false">
                     웹툰
                     </a>
                     <!--
                     <div class="dropdown-menu" aria-labelledby="navbarDropdownPortfolio">
...
<a class="dropdown-item" href="messages.html">Messages</a>
            ...
            <div class="row py-lg-5">
               <div class="col-lg-7">
                  ...
                  <div class="homepage-search-title">
                     ...
                     <h5 class="mb-5 text-shadow text-gray-800 font-weight-normal">Millions of people use Omelet to turn their ideas into reality.
                     </h5>
                  </div>
      ...
      <ul class="trusted-by bg-white border-bottom">
         ...
         <li><img src="images/mit.png"></li>
         <li><img src="images/netflix.png"></li>
         <li><img src="images/paypal.png"></li>
         <li><img src="images/intuit.png"></li>
         <li><img src="images/facebook.png"></li>
      </ul>
      <!--       social -->
      <!--       recent -->
